...
<body>
    <header>
        ...
        <ul class="menu_ul">
            ...
            <li class="menu_li"><a class="menus"href="productos.php">LISTA DE PRODUCTOS</a></li>
            <li class="menu_li"><a class="menus"href="insertar_producto">INSERCION DE PRODUCTOS</a></li>
            <li class="menu_li"><a class="menus"href="cerrar.php">Cerrar Session</a></li>
